    ...
    >
      ...
      >
        ...
        <ActionButton
          ...
          onClick={filteredSales.length > 0 ? handleDownload : undefined}
          colors={colors}
        >
          <FaDownload />
        </ActionButton>
      ...
      {isLoading ? (
        <EmptyState
          ...
          description="Consultando las ventas registradas."
          colors={colors}
        />
      ) : isError ? (
        <EmptyState
          title="No se pudo cargar el historial."
          description="Ocurrió un problema al consultar las ventas."
          colors={colors}
        />
      ) : sales.length === 0 ? (
